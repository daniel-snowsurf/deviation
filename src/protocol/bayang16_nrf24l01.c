...
#define CHANNEL_AUX1        CHANNEL15
#define CHANNEL_AUX2        CHANNEL16
enum {
    Bayang16_INIT1 = 0,
    Bayang16_BIND2,
    Bayang16_DATA
...
static void send_packet(u8 bind)
{
    ...
    if (bind) {
        ...
        packet[2] = GET_FLAG(CHANNEL_FLIP, 0x08)
            ...
            | GET_FLAG(CHANNEL_AUX1, 0x04)
            | GET_FLAG(CHANNEL_AUX2, 0x40);
