...
#define ADC_CHANNELS { \
    ...
    ADC_CHAN(GPIOA, GPIO0, CHAN_NONINV),  /* ADC123_0  - INP_AUX4 */ \
...
#define EXTRA_SWITCHES \
    ...
    EXTRA_2WAY(INP_SWH, 0x01, 0x02, CHAN_INVERT, SWITCH_2x1)

#define REPLACEMENT_SWITCHES \
    EXTRA_3WAY(INP_SWA, CH(23), CH(24), CHAN_NONINV, SWITCH_3x1) \
    EXTRA_3WAY(INP_SWB, CH(25), CH(26), CHAN_NONINV, SWITCH_3x2) \
    EXTRA_3WAY(INP_SWC, CH(27), CH(28), CHAN_NONINV, SWITCH_3x3) \
    EXTRA_3WAY(INP_SWD, CH(29), CH(30), CHAN_NONINV, SWITCH_3x4) \
